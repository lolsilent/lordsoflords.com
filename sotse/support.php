...
if ($item_name == $val) {
if ($val == 'Exp') {
	$amount=$dupe*5000000000; $buy_cost=99+$dupe;

} elseif ($val == 'Gold') {
	$amount=$dupe*5000000000; $buy_cost=49+$dupe;
...
if ($val == 'Exp') {
	$amount=$dupe*5000000000; $cost=99+$dupe;
} elseif ($val == 'Gold') {
	$amount=$dupe*5000000000; $cost=49+$dupe;
} elseif ($val == 'Strength' or $val == 'Intelligence' or $val == 'Weapon' or $val == 'Attackspell') {
...
+127 % Agility<br>
+127 % Intelligence<br>
+127 % Concentration<br>
+127 % Contravention<br>
...
+100 % Agility<br>
+100 % Intelligence<br>
+100 % Concentration<br>
+100 % Contravention<br>
1.000.000 seconds!<br>
