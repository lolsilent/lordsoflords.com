...
$mversion="276030256";
$mversion=number_format($mversion,'',0,'.');
...
mysqli_free_result ($result);
	...
	if (!empty($heip) and !empty($meip) and $heip !== $meip and $vrow->ip !== $row->ip) {
...
print("You have casted a vote on $vrow->Sex $vrow->Charname for $vrow->Apply.");
	...
	} else {echo "Ip match is higher then 75% your vote has been discarded.";}
...
$result = mysqli_query($link, "SELECT * FROM $tbl_members WHERE Sex='$val' ORDER BY Time desc");
$i=1;
