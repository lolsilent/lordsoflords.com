...
if ($row->Level >= 100) {
?>
<form name="chat" method="post" target="lol_chit" action="chat_global.php">
...
<form method=post target="lol_chit" action="chat.php"><td width=5%><input type=submit name="Action" value="<?php echo $server;?>" onClick="window.parent.frames['lol_control'].location='<?php echo $root_url;?>/chat_control.php'"></td></form></tr></table>
<?php 
} else {
echo $before_chat;
}
