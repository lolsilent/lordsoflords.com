...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=30514218114 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=5987041575 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=1965775 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `charname` (`charname`)
) ENGINE=MyISAM AUTO_INCREMENT=12582 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_members` (
  ...
  KEY `gold` (`gold`),
  KEY `timer` (`timer`)
) ENGINE=MyISAM AUTO_INCREMENT=16663 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=110681 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_papers` (
  ...
  `timer` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=2071089 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_save` (
  ...
  PRIMARY KEY (`id`),
  KEY `timer` (`timer`)
) ENGINE=MyISAM AUTO_INCREMENT=58417 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_steals` (
  ...
  `timer` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=135060 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_zlogs` (
  ...
  `timer` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=48680 DEFAULT CHARSET=latin1;
COMMIT;
