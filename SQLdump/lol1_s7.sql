...
CREATE TABLE IF NOT EXISTS `lol_charms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1587 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_world` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=80107 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_zlogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=24088 DEFAULT CHARSET=latin1;
COMMIT;
