...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9739 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_charms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=909879 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_deads` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=54308 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_duel` (
  ...
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=54996 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_paper` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3960 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_steals` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=48191 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_world` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=2345134 DEFAULT CHARSET=latin1;
