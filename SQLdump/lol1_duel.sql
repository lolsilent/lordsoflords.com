...
--
-- Table structure for table `lol_finder`
--

DROP TABLE IF EXISTS `lol_finder`;
CREATE TABLE IF NOT EXISTS `lol_finder` (
  `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `uid` varchar(32) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=36646 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `charname` (`charname`)
) ENGINE=MyISAM AUTO_INCREMENT=3884 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_members` (
  ...
  `twin` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  ...
  KEY `gold` (`gold`),
  KEY `timer` (`timer`)
) ENGINE=MyISAM AUTO_INCREMENT=4899 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_papers` (
  ...
  `timer` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=60853 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_steals` (
  ...
  `timer` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=40164 DEFAULT CHARSET=latin1;
