...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4034 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_charms` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=178079 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=2635 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_members` (
  ...
  KEY `Onoff` (`Onoff`),
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=7840 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_messages` (
  ...
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=14246 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_paper` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=221160 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_smembers` (
  ...
  KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=31957 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_steals` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=97821 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=54878 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_tourpaper` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=174084 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_tourwinner` (
  ...
  `Time` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=47095 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_zlogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=28543 DEFAULT CHARSET=latin1;
COMMIT;
