...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=105514 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=91711 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_deads` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=101284 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_duel` (
  ...
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=109258 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_graves` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6256 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=5254 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_members` (
  ...
  `Loginfailip` varchar(55) NOT NULL DEFAULT '',
  `Friend` varchar(55) NOT NULL DEFAULT '',
  ...
  KEY `Onoff` (`Onoff`),
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=6202 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_messages` (
  ...
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=17022 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_paper` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=86226 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_smembers` (
  ...
  KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=35299 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_steals` (
  ...
  `Date` varchar(50) NOT NULL DEFAULT '',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=74576 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_tourpaper` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=198625 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_tourwinner` (
  ...
  `Time` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=49507 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_world` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=136593 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_zlogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3849 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `lol_zspeed`
--

DROP TABLE IF EXISTS `lol_zspeed`;
CREATE TABLE IF NOT EXISTS `lol_zspeed` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `News` text NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
