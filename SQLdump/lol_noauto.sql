...
--
-- Table structure for table `lol_antibot`
--

DROP TABLE IF EXISTS `lol_antibot`;
CREATE TABLE IF NOT EXISTS `lol_antibot` (
...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  `level` decimal(200,0) NOT NULL DEFAULT '0',
  `message` varchar(255) NOT NULL DEFAULT '',
  `ip` varchar(15) NOT NULL DEFAULT '',
  `timer` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=47725 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=90878 DEFAULT CHARSET=latin1;
...
) ENGINE=MyISAM AUTO_INCREMENT=15969 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_history` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`charname`)
) ENGINE=MyISAM AUTO_INCREMENT=3431 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_items` (
  ...
  `timer` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=108044 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_members` (
  ...
  `xp` decimal(200,0) NOT NULL DEFAULT '0',
  `gold` decimal(200,0) NOT NULL DEFAULT '0',
  `stash` decimal(200,0) NOT NULL DEFAULT '0',
  ...
  `friend` varchar(15) NOT NULL DEFAULT '',
  ...
  KEY `Onoff` (`mute`),
  KEY `Time` (`timer`)
) ENGINE=MyISAM AUTO_INCREMENT=7144 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_papers` (
  ...
  `timer` int(10) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=374396 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_pets` (
  ...
  `level` bigint(20) UNSIGNED NOT NULL DEFAULT '0',
  `xp` decimal(200,0) UNSIGNED NOT NULL DEFAULT '0',
