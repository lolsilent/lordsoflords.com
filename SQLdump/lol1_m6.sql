...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Mar 05, 2018 at 12:59 AM
...
CREATE TABLE IF NOT EXISTS `lol_bitcoin` (
  ...
  `walletaccount` varchar(64) NOT NULL DEFAULT '',
...
--
-- Table structure for table `lol_bitcoin_prices`
--

DROP TABLE IF EXISTS `lol_bitcoin_prices`;
CREATE TABLE IF NOT EXISTS `lol_bitcoin_prices` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `coin` varchar(32) NOT NULL,
  `value` int(64) UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lol_board` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5203 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_charms` (
  ...
  `Dexterity` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `Agility` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `Intelligence` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `Concentration` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  `Contravention` tinyint(3) UNSIGNED NOT NULL DEFAULT '0',
  ...
  `a8` tinyint(3) UNSIGNED NOT NULL,
  `a9` tinyint(3) UNSIGNED NOT NULL,
  `Time` int(11) UNSIGNED NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=249103 DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Table structure for table `lol_coins`
--

DROP TABLE IF EXISTS `lol_coins`;
CREATE TABLE IF NOT EXISTS `lol_coins` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `name` varchar(128) NOT NULL,
  `coin` varchar(32) NOT NULL,
  `address` varchar(64) NOT NULL,
  `amount` decimal(20,8) NOT NULL,
  `rpcuser` varchar(64) NOT NULL,
  `rpcpassword` varchar(32) NOT NULL,
  `rpchost` varchar(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lol_deads` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=123626 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_duel` (
  ...
  KEY `Time` (`Time`)
) ENGINE=MyISAM AUTO_INCREMENT=124927 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_world` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `Charname` (`Charname`)
) ENGINE=MyISAM AUTO_INCREMENT=4419994 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `lol_zlogs` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=6483 DEFAULT CHARSET=latin1;
COMMIT;
