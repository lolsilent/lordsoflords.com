...
function message_amount($in) {
	global $sid,$row,$tbl_messages,$gid,$current_time,$message_limit,$status_array;
...
function message_inbox($mid) {
	global $sid,$row,$tbl_messages,$gid,$current_time,$message_limit;
...
function message_reply($mid) {
		global $sid,$row,$tbl_messages,$fld_messages,$gid,$current_time,$current_date,$message;
